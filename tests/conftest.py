...
def get_full_madgraph_setup(tmp_path):
    ...
    stage2_prod_cmd = partial("DelphesPythia8_EDM4HEP {0} {1} {2} {3}".format, str(IDEA_card), str(edm4hep_card), str(pythia_card))
...
def get_full_whizard_setup(tmp_path):
    ...
    stage2_prod_cmd = partial("DelphesSTDHEP_EDM4HEP {0} {1} {3} {2}".format, str(IDEA_card),str(edm4hep_card))
