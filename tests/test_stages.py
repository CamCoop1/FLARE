...
@pytest.mark.parametrize("stage, error", (['stage1', RuntimeError], ['stage2', FileNotFoundError]))
def test_get_stage_script_for_Errors(
    setup_analysis_files_for_Errors,
    stage,
    error
    ):
    """ 
...
def test_get_stage_script_for_correct_operation(setup_analysis_for_unregistered_stage_file):
